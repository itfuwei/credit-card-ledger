...
import { Delete, EditPen, Plus, Present, Search } from '@element-plus/icons-vue'
import { formatMoneyFromFen } from '../../domain/billing'

const props = defineProps({ cards: { type: Array, required: true }, loading: Boolean })
const emit = defineEmits(['edit', 'delete', 'toggle-status', 'manage-products', 'create-transaction', 'create-activity'])
const query = ref('')
